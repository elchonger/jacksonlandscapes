...
<html lang="en">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-FBQKQNL595"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'G-FBQKQNL595');
        </script>
    </head>
    <body id="page-top">
        <!--back to top button-->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <iframe src="https://jacksonlandscapes.uk/contact/form.php" height="500px" width="100%"></iframe>
...
<div class="alert text-center cookiealert" role="alert">
    <b>To improve your experience, this website uses cookies. Click accept to proceed or read more to view details about the cookies we use. 

    <button type="button" class="btn btn-primary btn-sm acceptcookies">
        Accept
        </button> <a class="cookie-link" href="https://en.wikipedia.org/wiki/General_Data_Protection_Regulation" target="_blank">read more</a></b>
</div>
